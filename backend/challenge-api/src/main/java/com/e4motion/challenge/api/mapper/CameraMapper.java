...
public interface CameraMapper {
    ...
    @Mapping(target = "latitude", expression = MappingExpression.TO_CAMERA_LATITUDE)
    @Mapping(target = "longitude", expression = MappingExpression.TO_CAMERA_LONGITUDE)
    ...
    @Mapping(target = "lane", expression = MappingExpression.TO_CAMERA_ROAD_LANE)
    @Mapping(target = "direction", expression = MappingExpression.TO_CAMERA_ROAD_DIRECTION)
