...
export const displayIntersection = (intersections) => {
...
export const displayCamera = (cameras, level) => {
...
export const displayLinks = (links, kakaoMap, level) => {
...
const getTrafficSignalType = (trafficLights, signalDatas) => {
    let signalType = "d";
...
export const displayTrafficLights = (trafficLights) => {
...
function KakaoMap({
    ...
    return (
        ...
        >
            ...
            {links?.isShow && displayLinks(links, kakaoMap, level)}
